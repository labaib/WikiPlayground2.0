...
import { opacApi, authorBookList } from "./js/opac.js"
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-3 d-flex mx-1">
                        ...
                        <a type="button" href="#" class="btn btn-outline-secondary border-0 justify-content-center align-items-center" style="width: 2.5em;  height: 2.5em; padding-left: 0.45em;" target="_blank">
...
document.getElementsByName('input[name="radio-button"]').addEventListener("click", function(event) {
    event.preventDefault()
